...
public class My_Job_Finished extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myjob_finished);
        ...
        {
            Intent newActivity = new Intent(My_Job_Finished.this, MainActivity.class);
    ...
    public void ShowData() {
        ...
        String url = "http://thaiprojectapp.com/kaiau/myjob_finished.php?user_id="+ strMemberID;
        // Paste Parameters
        ...
        try {
            ...
            lisView1.setAdapter(new My_Job_Finished.ImageAdapter(this));
