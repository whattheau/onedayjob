...
public class My_Job_Approve extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myjob_approve);
        ...
        {
            Intent newActivity = new Intent(My_Job_Approve.this, MainActivity.class);
    ...
    public void ShowData() {
        ...
        String url = "http://thaiprojectapp.com/kaiau/myjob_approve.php?user_id="+ strMemberID;
        // Paste Parameters
        ...
        try {
            ...
            lisView1.setAdapter(new My_Job_Approve.ImageAdapter(this));
