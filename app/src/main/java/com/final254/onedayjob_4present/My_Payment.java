...
public class My_Payment extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent newActivity = new Intent(My_Payment.this, MainActivity.class);
    ...
    public void show_User_Profile()
    {
        ...
        String url = "http://thaiprojectapp.com/kaiau/myprofile.php?user_id="+ strMemberID;
